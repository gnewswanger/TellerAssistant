Public NotInheritable Class FormSplash
    ...
    Private Sub FormSplash_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        Me.OnMainFormShowing(sender, e)
    End Sub
    ...
    Public Sub New()
        ...
        AddHandler FormMain2012.MainFormShowing, AddressOf OnMainFormShowing
